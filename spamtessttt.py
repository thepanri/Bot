...
def send_otp_via_mutosi(sdt):
    ...
    try:
        ...
        print(f"An error occurred while registering: send_otp_via_mutosi")
...
def send_otp_via_mutosi1(sdt):
    ...
    try:
        ...
        print(f"An error occurred while sending OTP: send_otp_via_mutosi")
...
def send_otp_via_vietair(sdt):
    ...
    try:
        ...
        print(f"An error occurred: send_otp_via_vietair")
